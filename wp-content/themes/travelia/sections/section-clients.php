<?php if(get_theme_mod('travelia_clients_enable')):?>
	<!-- Start Clients -->
			...
			<div class="row">
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="clients-slider">
						<?php
						$clients_catId = get_theme_mod( 'travelia_clients_category_id','1' );
						$client_number = get_theme_mod( 'travelia_client_number','5' );
