 ...
 * @return array Files.
 */
function kingcabs_ocdi_files() {

	return array(
		array(
			'import_file_name'             => esc_html__( 'Theme Demo Content', 'kingcabs' ),
			'local_import_file'            => trailingslashit( get_template_directory() ) . 'sparklethemes/ocdi/Kingcabs.xml',
			'local_import_widget_file'     => trailingslashit( get_template_directory() ) . 'sparklethemes/ocdi/Kingcabs.wie',
			'local_import_customizer_file' => trailingslashit( get_template_directory() ) . 'sparklethemes/ocdi/Kingcabs.dat',
			),
		);
}

add_filter( 'pt-ocdi/import_files', 'kingcabs_ocdi_files', 99 );
 ...
 * @since 1.0.0
 */
function kingcabs_ocdi_after_import() {
...
add_action( 'pt-ocdi/after_import', 'kingcabs_ocdi_after_import' );
